...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle?) {
        ...
        Log.i(
            MAIN_RESTORE_LOG_TAG,
            MAIN_RESTORE_LOG_MESSAGE
        )
    ...
    private fun isHistory() {
        if (!SharedPrefs.isEmpty(this)) {
            main_toolbar.menu.findItem(R.id.action_history).isVisible = true
        }
    }
